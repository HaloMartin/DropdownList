...
static MCAppDelegate* shareDelegate = nil;
...
{
    return (UINavigationController*)shareDelegate.window.rootViewController;
}

- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    // Override point for customization after application launch.
    shareDelegate = self;
    MCDropdownListViewController* vc = [[MCDropdownListViewController alloc] init];
